...
namespace {
struct qt_meta_tag_ZN11SensorPanelE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11SensorPanelE = QtMocHelpers::stringData(
    "SensorPanel",
    "onSensorDataUpdated",
    "",
    "SensorData",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11SensorPanelE[] = {
...
Q_CONSTINIT const QMetaObject SensorPanel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11SensorPanelE.offsetsAndSizes,
    qt_meta_data_ZN11SensorPanelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11SensorPanelE_t,
        // Q_OBJECT / Q_GADGET
...
void *SensorPanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11SensorPanelE.stringdata0))
